...
(function () {
  const navHTML = `
    <nav class="floating-sidebar" aria-label="Main navigation">
        ...
        <a href="class-dashboard.html" class="sidebar-item" data-section="registration" title="Registration">
            <i data-feather="book" class="w-5 h-5"></i>
            <span class="tooltip">Student Registration</span>
        </a>
        <a href="class-courses.html" class="sidebar-item" data-section="list" title="Students List">
