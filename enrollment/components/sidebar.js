...
(function () {
  const navHTML = `
    <nav class="floating-sidebar" aria-label="Main navigation">
        ...
        <a href="index.html" class="sidebar-item" data-section="registration" title="Registration">
        ...
        <a href="logout.html" class="sidebar-item" data-section="logout" title="Logout">
