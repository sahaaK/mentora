...
(function () {
  const navHTML = `
    <nav class="floating-sidebar" aria-label="Main navigation">
        ...
        <a href="attendance.html" class="sidebar-item" data-section="dashboard" title="Dashboard">
            <i data-feather="grid" class="w-5 h-5"></i>
            <span class="tooltip">Dashboard</span>
        </a>
        
        
        <a href="courses.html" class="sidebar-item" data-section="logout" title="Logout">
